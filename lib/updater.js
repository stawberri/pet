...
exports = module.exports = currentVersion => {
  ...
  return new Promise((resolve, reject) => {
    ...
    // If updatePrompted this version or last check was less than 5 minutes ago
    if($.updater.prompt === currentVersion || Date.now() - $.updater.check < 300000) return reject()
    $.updater.check = Date.now()
    ...
    if(updateAvailable) _.$('update-available', currentVersion, updateAvailable, 'npm i petpet -g')
    return file
  })
}
